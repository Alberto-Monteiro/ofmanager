...
import { ArtefatoComponent } from 'app/entities/artefato/artefato.component';
...
describe('Component Tests', () => {
  describe('Artefato Management Component', () => {
    let comp: ArtefatoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ArtefatoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.artefatoes && comp.artefatoes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
