...
export class OrdemDeFornecimentoComponentsPage {
  ...
  deleteButtons = element.all(by.css('of-ordem-de-fornecimento div table .btn-danger'));
  title = element.all(by.css('of-ordem-de-fornecimento div h2#page-heading span')).first();
...
export class OrdemDeFornecimentoUpdatePage {
  pageTitle = element(by.id('of-ordem-de-fornecimento-heading'));
...
export class OrdemDeFornecimentoDeleteDialog {
  private dialogTitle = element(by.id('of-delete-ordemDeFornecimento-heading'));
  private confirmButton = element(by.id('of-confirm-delete-ordemDeFornecimento'));
